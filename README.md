...
- 也可以直接引用线上cdn地址，注意要使用最新的版本号，例如：
  ...
  - https://gw.alipayobjects.com/os/lib/tinyjs-plugin-transformable/0.0.6/index.js
  - https://gw.alipayobjects.com/os/lib/tinyjs-plugin-transformable/0.0.6/index.debug.js
